...
const filterReports = (gridFilter) => {
  ...
  reportsFiltered.value = reports.value.filter(
    (item) => item.category === gridFilter || gridFilter === 'All',
  )
}
...
const colDefs = [
  ...
  { field: 'category', cellDataType: 'text' },
  {
    ...
    onCellClicked: function (params) {
      if (params.data.imageUrl) showImage(params.data)
    },
  },
]
</script>
